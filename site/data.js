  ...
  "programs": [
    {
      ...
      "progression": [
        ...
        "Year 3: use Animal Behavior and organismal/wildlife electives to build a behavior-oriented focus; add GIS and deeper faculty research.",
      ...
      "tradeoffs": [
        ...
        "Behavioral ecology can be emphasized through electives, research, and faculty mentorship, but it is not presented as an official named emphasis in the Wildlife Ecology B.S."
      ],
    ...
    {
      "code": "UMA-AS",
      "title": "Animal Science B.S. (Animal Management concentration)",
      ...
      "fundamental": "A rigorous Animal Science B.S. using the official Animal Management concentration, centered on anatomy, physiology, genetics, nutrition, reproduction, health, welfare, and animal management, with behavior and exotic/wildlife electives available around a domestic/agricultural core.",
      "scienceFoundation": [
      ...
      "experience": "Strong hands-on animal-management infrastructure, but much of it is built around domestic livestock and equine systems. Animal Management is one of UMass Amherst’s three official Animal Science concentrations; behavior/welfare interests are built through electives, research, and experience rather than a named Behavior concentration.",
    ...
    {
      "code": "UMA-BIO",
      "title": "Biology B.S. (ecology and behavior electives)",
      "school": "UMass Amherst",
      "overview": "Institutional profile. Massachusetts’ flagship is the largest and broadest institutional platform in the shortlist. Amherst is a genuine college town embedded in the Five College region, combining a major residential university with access to Amherst College, Smith, Mount Holyoke and Hampshire coursework. Academic environment. For Fall 2025, UMass reported more than 23,000 undergraduates, an average class size of 35, 77% of classes below 40 students, 18:1 student-faculty ratio, 92% first-year retention, 75.4% four-year graduation and 83.4% six-year graduation. The science pathways are conventionally demanding, especially Biology, but the completion environment is strong. Research and experience ecosystem. The major advantage is scale: many laboratories, departments, courses, funded summer programs, honors research and external internships. The corresponding risk is execution: animal-specific identity, faculty relationships and specialized experience need to be built intentionally.",
      "fundamental": "A broad Biology B.S. that can connect genes, cells, physiology, nervous systems, evolution, ecology, and environment to animal behavior. Ecology and behavior are an informal advising/elective pathway rather than an officially named concentration, so the animal specialization must be constructed deliberately.",
      "scienceFoundation": [
      ...
      "sources": [
        ...
        "www.umass.edu/biology/ecology-and-evolutionary-biology-course-guide"
      ],
    ...
    {
      "code": "UMA-WEC",
      "title": "Natural Resources Conservation B.S. (Wildlife Ecology & Conservation concentration)",
      "school": "UMass Amherst",
      "overview": "Institutional profile. Massachusetts’ flagship is the largest and broadest institutional platform in the shortlist. Amherst is a genuine college town embedded in the Five College region, combining a major residential university with access to Amherst College, Smith, Mount Holyoke and Hampshire coursework. Academic environment. For Fall 2025, UMass reported more than 23,000 undergraduates, an average class size of 35, 77% of classes below 40 students, 18:1 student-faculty ratio, 92% first-year retention, 75.4% four-year graduation and 83.4% six-year graduation. The science pathways are conventionally demanding, especially Biology, but the completion environment is strong. Research and experience ecosystem. The major advantage is scale: many laboratories, departments, courses, funded summer programs, honors research and external internships. The corresponding risk is execution: animal-specific identity, faculty relationships and specialized experience need to be built intentionally.",
      "fundamental": "A Wildlife Ecology & Conservation concentration within the Natural Resources Conservation B.S., emphasizing field sampling, populations, habitats, quantitative ecology, GIS, management, and the interaction between wildlife and landscapes.",
      "scienceFoundation": [
      ...
      "experience": "More structured for field/wildlife work than UMass Biology. UMass states that the Wildlife Ecology & Conservation concentration provides the coursework required to qualify for Associate Wildlife Biologist certification from The Wildlife Society.",
    ...
    {
      "code": "UNE-AN",
      "title": "Animal Behavior B.S. with Neuroscience minor",
      "school": "University of New England",
      "overview": "Institutional profile. UNE is the smallest and most specialized environment in the shortlist. The Animal Behavior program is based on the coastal Biddeford campus in southern Maine, with relatively small classes and close faculty contact. The location offers coastal access and proximity to the Portland/southern Maine region, while the campus itself is quieter than a large college town. Academic environment. UNE reports a roughly 12:1 student-teacher ratio and average class size around 18. Recent first-year retention has generally been in the upper 70% range; cohort four-year graduation has varied roughly from the mid-50s to mid-60s, with six-year rates in the low-60s to around 70%. The program is not academically light: it combines biology, chemistry, statistics, research methods, labs, reading/writing and behavioral research. Research and experience ecosystem. The major strength is low execution risk for an animal-behavior identity. Behavior, cognition, learning, communication, welfare/captive-management options, research and internships are central rather than something that must be assembled from several departments.",
      "fundamental": "The Animal Behavior B.S. paired with UNE’s separate Neuroscience minor, adding formal depth in neural systems and cognition while retaining animal behavior as the major.",
      "scienceFoundation": [
      ...
      "experience": "Animal experience and behavior research remain anchored in the Animal Behavior major. The separate Neuroscience minor adds mechanistic scientific depth rather than replacing internships or animal-focused electives.",
      "research": "Best suited to questions connecting behavior, cognition, and nervous-system mechanisms. The Neuroscience minor is a separate credential rather than an option within the Animal Behavior major; sequencing should be planned so it does not crowd out research, internships, or organismal electives.",
      "progression": [
      ...
      "tradeoffs": [
        ...
        "The additional minor uses elective capacity that might otherwise support research, internships, or organismal electives, so sequencing should be planned carefully."
      ],
      ...
      "sources": [
        "www.une.edu/cas/schools/social-behavioral-sciences/programs/bs-animal-behavior",
        "www.une.edu/cas/schools/social-behavioral-sciences/programs/bs-neuroscience",
        "www.une.edu/catalog"
      ],
    ...
    {
      "code": "URI-AZ",
      "title": "Animal and Veterinary Science B.S. (Animal Science option) + Zoo and Aquarium Science Certificate",
      ...
      "fundamental": "A managed-animal route combining URI’s Animal and Veterinary Science B.S. Animal Science option with the Zoo and Aquarium Science Certificate, linking physiology, health, behavior, nutrition, reproduction, care, and management to evidence-based zoo/aquarium welfare, husbandry, training, and research.",
      "scienceFoundation": [
      ...
      "experience": "URI currently describes the Zoo and Aquarium Science Certificate as open to all undergraduates. It is a 12-credit, five-course certificate that includes zoo management at Roger Williams Park Zoo and an internship-linked practicum; pairing it with the Animal Science option creates a particularly structured managed-animal route.",
    ...
    {
      "code": "URI-WZ",
      "title": "Wildlife & Conservation Biology B.S. + Zoo & Aquarium Science Certificate",
      "school": "University of Rhode Island",
      "overview": "Institutional profile. URI is a New England flagship with a classic residential campus in Kingston and access to South County, Narragansett, Newport and Providence. Its scale is large enough for broad university resources but smaller and more concentrated than UMass. Academic environment. URI’s recent institutional reporting places first-year retention in the mid-80% range and completion around the high-50s for four years and roughly 70% by six years. Many classes are relatively small for a public university. The academic environment is serious STEM with laboratories, field methods, experiential learning and undergraduate research. Research and experience ecosystem. URI has become the most interesting school for within-institution flexibility between wildlife/conservation and animals under human care. The Zoo & Aquarium Science certificate, Roger Williams Park Zoo course connection, formal wildlife experiential sequence and funded undergraduate research provide unusually visible pathways.",
      ...
      "experience": "The broadest cross-over between wild and managed animals in the shortlist. URI currently describes the 12-credit, five-course Zoo and Aquarium Science Certificate as open to all undergraduates; it includes zoo management at Roger Williams Park Zoo and an internship-linked practicum.",
      ...
      "tradeoffs": [
        "Certificate sequencing still needs planning: AVS 343 requires AVS 331 or instructor permission, and AVS 398 requires AVS 327 or permission plus a concurrent or recent zoo/aquarium internship.",
